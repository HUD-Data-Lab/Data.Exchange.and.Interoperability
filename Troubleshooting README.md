...
│ │                   │   )                                                                                                                                                     │ │
│ │                   ]                                                                                                                                                         │ │
│ │   effect_system = <hmis_codegen.effects.EffectSystem object at 0x000001748CB1BA10>                                                                                          │ │
│ │          errors = []                                                                                                                                                        │ │
│ │          format = 'all'                                                                                                                                                     │ │
│ │ generated_files = []                                                                                                                                                        │ │
│ │       generator = <hmis_codegen.generator.Generator object at 0x000001748CB1BE00>                                                                                           │ │
│ │        handlers = [                                                                                                                                                         │ │
│ │                   │   EffectHandler(                                                                                                                                        │ │
│ │                   │   │   name='AuthorizationCheck',                                                                                                                        │ │
...
│ │                   )                                                                                                                                                         │ │
│ │ ontology_parser = <hmis_codegen.parser.OntologyParser object at 0x000001748C973B60>                                                                                         │ │
...
│ │     yaml_parser = <hmis_codegen.parser.YAMLLDParser object at 0x000001748C973380>                                                                                           │ │
│ ╰─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╯ │
│                                                                                                                                                                                 │
│ C:\Users\gtuio\OneDrive\Documents\GitHub\002.GT.Data.Exchange.and.Interoperability\hmis-codegen\src\hmis_codegen\generator.py:46 in generate_jsonld_context                     │
│                                                                                                                                                                                 │
│    43 │   │   │   for prop in schema.properties:                                                                                                                                │
│    44 │   │   │   │   if prop.semantic.semantic_uri:                                                                                                                            │
│    45 │   │   │   │   │   # Map OpenAPI field name to ontology property                                                                                                         │
│ ❱  46 │   │   │   │   │   local_name = prop.semantic.semantic_uri.split('#')[-1]                                                                                                │
│    47 │   │   │   │   │   context[prop.name] = local_name                                                                                                                       │
│    48 │   │                                                                                                                                                                     │
│    49 │   │   return template.render(                                                                                                                                           │
│                                                                                                                                                                                 │
│ ╭────────────────────────────────────────────────────────────────────────────────── locals ───────────────────────────────────────────────────────────────────────────────────╮ │
│ │  context = {'@vocab': 'http://hmis.hud.gov/ontology#'}                                                                                                                      │ │
...
│ │            │   hud_csv_table=None                                                                                                                                           │ │
│ │            )                                                                                                                                                                │ │
│ │     self = <hmis_codegen.generator.Generator object at 0x000001748CB1BE00>                                                                                                  │ │
│ │     spec = OpenAPISpec(                                                                                                                                                     │ │
│ │            │   title='HMIS API Sandbox Specifications',                                                                                                                     │ │
│ │            │   version='1.0.0',                                                                                                                                             │ │
│ │            │   description='HMIS API Sandbox request, response, and error responses for each scenario in the'+323,                                                          │ │
...
│ │            │   }                                                                                                                                                            │ │
│ │            )                                                                                                                                                                │ │
│ │ template = <Template 'jsonld_context.j2'>                                                                                                                                   │ │
│ ╰─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╯ │
╰─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╯
